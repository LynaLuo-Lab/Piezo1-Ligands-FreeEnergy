...
namespace eval ::silcs:: {
    ...
    variable fragmaps_enabled {
        ...
        clbx flbx brbx clex fetx tfex dmeo
    }
...
SilcsBio, 2021 - http://silcsbio.com" -anchor center -justify center -background #3857a5 -foreground white -font bold
